package com.javasampleapproach.twitterbootstrap.utility.linkedin;
...
public class Linkedin {
    private static String API_KEY = "77a5ejqrap6au0";
    private static String API_SECRET = "2Mbkkve07DT2kYJJ";
    ...
    public static void main(String[] args) {
    	 ...
    	 try {
 			...
 			OAuthService service = new ServiceBuilder()
 		        ...
 		        .callback("https://localhost:3000/login/callback")
 		        .build();
    ...
    /*
        ...
        OAuthService service = new ServiceBuilder()
                                ...
                                .apiKey(API_KEY)
                                .apiSecret(API_SECRET)
                                .callback("http://localhost:8080/login/callback")
                                .build();
